...
function renderSelectionPage(articles) {
  var selectionItems = readReviewSelectionItems(articles);
  ...
  for (var i = 0; i < sorted.length; i++) {
    ...
    var titleHtml = isReviewQueue
      ? '<strong class="card-title">' + escapeHtml(a.title) + '</strong>'
