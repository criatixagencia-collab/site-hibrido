...
```txt
Paragrafo 1: fato principal
Paragrafo 2: contexto
Paragrafo 3: detalhe ou fala
Paragrafo 4: consequencia, servico ou proximo passo
```

## Tamanho recomendado

- Titulo: curto, direto, com uma ideia central.
- Linha de apoio: uma frase.
- Noticia rapida: 3 a 5 paragrafos curtos.
- Contexto: 5 a 8 paragrafos curtos.
- Lista/servico: blocos escaneaveis.

## Regras de seguranca

- Acusacao: sempre atribuir.
- Rumor: nunca tratar como certeza.
- Luto/saude: tom sobrio.
...
```txt
Direta como portal.
Popular sem virar gritaria.
Curiosa sem inventar.
Rapida para celular.
Factual antes de opinativa.
```
